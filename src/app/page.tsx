    ...
    <div className="flex justify-center items-center min-h-screen bg-[#898AC4]">
      <div className="p-4 bg-[#A2AADB] rounded-2xl">
        ...
        <div className="mt-3 relative w-full">
          ...
          onChange={checkInput}/>
          <button id="search-button" className="absolute right-3 top-1/2 -translate-y-1/2 bg-[#898AC4] text-[#FFF2E0] rounded-2xl p-1 hover:bg-[#C0C9EE] hover:text-[#898AC4] hover:outline-2 active:scale-85 outline-[#898AC4] transition-discrete duration-75 cursor-pointer" onClick={() => sendQuery(router)}>
