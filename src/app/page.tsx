  ...
  return (
    <div className="flex justify-center items-center min-h-screen bg-[#898AC4]">
      <div className="p-4 bg-[#A2AADB] rounded-2xl">
        ...
        <footer className="mt-3 text-center text-sm font-light">Created By <Link className="font-bold" href="https://admryn.my.id/">AdamRoyn</Link> (first project, yay!)</footer>
      </div>
    </div>
  );
}
